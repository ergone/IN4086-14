...
var NURI = "data/wdi/wdi_numbers.json", PURI = "data/wdi/wdi_percent.json", ActiveSeries, ActiveYear
AvailableNumericSeries = [], AvailablePercentageSeries = [], 
Categories = [], Years = [], DataSeries = [];
...
function PopulateForms(series) {
    ...
    ActiveYear = AvailableSeriesYDefault = "yr2014";   
...
$.getJSON(PURI, function(data) { PopulateArray(data, PURI); PopulateForms(AvailablePercentageSeries); });
